    ...
    return (
        <div className='container w-full max-w-md mx-auto px-4 pt-20 md:pt-6'>
            ...
            <div className='border flex flex-col rounded-2xl overflow-hidden justify-between'>
                <header
                    className='py-2 px-4 md:px-6 bg-indigo-900 text-white font-bold text-lg md:text-2xl'>
                    Produto
                </header>
                ...
                <div className="flex flex-row">
                    ...
                    <button
                        className='w-full text-slate-100 bg-indigo-800 hover:bg-indigo-700 flex items-center justify-center text-base md:text-lg cursor-pointer'
