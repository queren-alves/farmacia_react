  ...
  return (
    <div className="container flex flex-col items-center justify-center px-2 pt-4 mx-auto">
      ...
      >
        ...
        <button
          className="flex justify-center w-full py-2 mx-auto text-base rounded text-slate-100 bg-indigo-900 hover:bg-indigo-800 md:w-1/2 md:text-lg cursor-pointer"
          type="submit"
        >
          {isLoading ?
            <ClipLoader
